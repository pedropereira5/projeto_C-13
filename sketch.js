var bow , arrow;
var bowImage, arrowImage, green_balloonImage,fundo, red_balloonImage, pink_balloonImage ,blue_balloonImage;

var score=0;

function preload(){
  fundo = loadImage("background0.png");
